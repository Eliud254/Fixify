...
const HowItWorks = () => {
  return (
    <div className="text-center p-24 custom-button-bg">
      <h1 className="text-4xl font-bold my-8 text-blue-900">How It Works</h1>
      <div className="flex justify-center space-x-4 my-8 mt-20">
        <div className="flex flex-col items-center main-bg-color p-16 flex-1 rounded-md cursor-pointer hover:opacity-75">
